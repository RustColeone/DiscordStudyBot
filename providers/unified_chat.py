...
def plan_agent_actions(user_input: str, tools: list, channel_id: int, time) -> list:
    ...
    for _ in range(attempts):
        prompt = (
            ...
            "Choose web_search when live or recently changed information is needed, when the user explicitly "
            "requests web research or sources, or when you are not confident that your knowledge can answer "
            "accurately. Do not choose web_search for casual conversation or stable facts you know reliably. "
